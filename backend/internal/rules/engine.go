...
// RuleDefinition represents declarative JSON rules with condition-action pairs.
...
type ConditionNode struct {
	Op       string          `json:"op"` // AND, OR, NOT, eq, gt, lt, contains, in_zone, cross_line
...
type Action struct {
	Type   string          `json:"type"` // alert, webhook, record, notify
...
// Evaluate checks whether an event payload satisfies the rule definition (stub evaluator).
