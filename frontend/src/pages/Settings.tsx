...
export default function Settings() {
  ...
  return (
    <div className="cv-section-stack">
      ...
      {msg && (
        <p className="text-sm text-cv-accent bg-cv-accent/10 border border-cv-accent/20 rounded-lg px-4 py-2">
          {msg}
        </p>
      )}

      <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr] cv-section-grid">
