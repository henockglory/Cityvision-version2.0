...
import { Plus, User, Shield, Users as UsersIcon } from 'lucide-react';
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-cv-border">
                <th className="text-left px-5 py-3 text-xs font-medium text-cv-muted uppercase tracking-wider">User</th>
