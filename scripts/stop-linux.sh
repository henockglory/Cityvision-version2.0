...
for svc in frontend ai-engine rules-engine backend watch-backend watch-ai-ingest watch-demo-stack watch-rules-engine watch-infra-ports watch-business-readiness watch-frontend; do
